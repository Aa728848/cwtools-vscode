  ...
  return {
    ...
    hints: [
      ...
      },
      {
        ...
        recommendedTools: ['query_types', 'query_workspace_index', 'query_definition_by_name'],
        guardrails: ['Treat empty text search results as inconclusive without indexed verification.'],
      },
    ],
  };
}
