...
export const BUILTIN_PROVIDERS: Record<string, AIProviderConfig> = {
    antigravity: {
        ...
        supportsFIM: true,
        inlineModels: ['tab_flash_lite_preview'],
        supportsVision: true,
        runtimeKind: 'http',
    ...
    tokenrhythm: {
        id: 'tokenrhythm',
        registerUrl: 'https://tokenrhythm.studio/',
    ...
    commandcode: {
        id: 'commandcode',
        registerUrl: 'https://commandcode.ai/docs/provider',
        name: 'Command Code',
    ...
    'kimi-code-plan': {
        id: 'kimi-code-plan',
        registerUrl: 'https://www.kimi.com/code/console',
