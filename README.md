...
flowchart TD
    ...
    subgraph Webview [Webview 隔离沙盒 (Rollup 捆绑)]
        UI["Chat & Manager UI"]
        Canvas["GUI 实时画布"]
        3D["恒星系 / Asset 3D 渲染"]
        Graph["科技/事件依赖图"]
    ...
    subgraph Backend [.NET 9 / F# 语言服务器]
        LSP["CWTools LSP Server\nsrc/Main.exe"]
        Lib["CWTools F# 库\nsubmodules/cwtools"]
    end
