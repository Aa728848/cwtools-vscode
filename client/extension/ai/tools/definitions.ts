        ...
        function: {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    encoding: { type: 'string', enum: ['utf8', 'utf8bom'], description: 'File encoding. Prefer utf8 (without BOM) for all PDXScript files (common, events, gfx, interface, etc.). NEVER use utf8bom for game scripts. Localisation YAML must use write_localisation.' },
                },
        ...
        function: {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    encoding: { type: 'string', enum: ['utf8', 'utf8bom'], description: 'Optional encoding override. Omit to preserve existing encoding. All PDXScript files must remain utf8 without BOM.' },
                },
