...
Copy-Item -Path .\release\bin\server\win-x64\* -Destination 'C:\Users\A\.vscode\extensions\eddy.eddy-stellaris-cwt-1.1.5\bin\server\win-x64' -Recurse -Force
Copy-Item -Path .\release\bin\client\extension\* -Destination 'C:\Users\A\.vscode\extensions\eddy.eddy-stellaris-cwt-1.1.5\bin\client\extension' -Recurse -Force
```
