...
const validators = {
    ...
    loadTopicMessages: fields({ messages: isRecordArray }, { targetSurface: optional(isSurface), toolPresentationMode: optional(isOneOf(['ptc', 'native', 'hybrid'] as const)) }),
    ...
    setToolPresentationMode: fields({ mode: isOneOf(['ptc', 'native', 'hybrid'] as const), locked: isBoolean }),
