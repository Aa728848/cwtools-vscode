...
1. **CWT/LSP schema and typed indexes**: \`get_lsp_status\`, \`query_rules\`, \`query_override_modes\`, \`query_scope\`, \`query_types\`, \`query_scripted_effects\`, \`query_scripted_triggers\`, \`query_enums\`, \`query_static_modifiers\`, \`query_variables\`, \`get_completion_at\`.
