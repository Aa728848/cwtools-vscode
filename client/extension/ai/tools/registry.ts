...
export type AgentToolName =
    | 'query_scope' | 'query_types' | 'query_rules' | 'query_override_modes' | 'search_rule_capabilities' | 'explain_scope' | 'parse_pdx_fragment' | 'remove_ignored_diagnostic'
...
const BASE_READ: AgentToolName[] = [
    'query_scope', 'query_types', 'query_rules', 'query_override_modes', 'search_rule_capabilities', 'explain_scope', 'parse_pdx_fragment', 'query_localisation_index', 'query_workspace_index', 'query_references',
...
const LOC_MODES = new Set([
    ...
    'query_types', 'query_rules', 'query_override_modes', 'search_rule_capabilities', 'explain_scope', 'parse_pdx_fragment', 'query_references', 'todo_write', 'write_localisation', 'git_ops',
