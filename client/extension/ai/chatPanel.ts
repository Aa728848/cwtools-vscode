        ...
        const messages: ChatMessage[] = [
            {
                ...
                content: [
                    ...
                    'When explicitExecutionRequest=true and requiresUserDecision=false, intent must be "execute" even for a complex task; the user has already chosen execution.',
