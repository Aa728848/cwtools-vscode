...
- **NO INLINE SCRIPT EXECUTION**: \`python -c\`, \`node -e\`, and similar inline code execution patterns are **blocked by the security sandbox**. Always write a temporary script file first (e.g. \`agent_helper.py\`) and then execute it.
