...
let parseDidOpenTextDocumentParams =
    deserializerFactory<DidOpenTextDocumentParams> readOptions

let parseDidChangeTextDocumentParams =
    deserializerFactory<DidChangeTextDocumentParams> readOptions

let parseWillSaveTextDocumentParams =
    deserializerFactory<WillSaveTextDocumentParams> readOptions

let parseDidSaveTextDocumentParams =
    deserializerFactory<DidSaveTextDocumentParams> readOptions

let parseDidCloseTextDocumentParams =
    deserializerFactory<DidCloseTextDocumentParams> readOptions

let parseDidFocusFileParams = deserializerFactory<DidFocusFileParams> readOptions

let parseDidChangeWatchedFilesParams =
    deserializerFactory<DidChangeWatchedFilesParams> readOptions
...
let parseInitialize =
    deserializerFactory<InitializeParamsRaw> readOptions >> parseInitializeParams

let parseTextDocumentPositionParams =
    deserializerFactory<TextDocumentPositionParams> readOptions
...
let parseDocumentSymbolParams =
    deserializerFactory<DocumentSymbolParams> readOptions
...
let private parseDocumentOnTypeFormattingParamsRaw
    (raw: DocumentOnTypeFormattingParamsRaw)
...
let parseDocumentFormattingParams =
    deserializerFactory<DocumentFormattingParamsRaw> readOptions
    >> parseDocumentFormattingParamsRaw

let parseDocumentRangeFormattingParams =
    deserializerFactory<DocumentRangeFormattingParamsRaw> readOptions
    >> parseDocumentRangeFormattingParamsRaw

let parseDocumentOnTypeFormattingParams =
    deserializerFactory<DocumentOnTypeFormattingParamsRaw> readOptions
    >> parseDocumentOnTypeFormattingParamsRaw

let parseRenameParams = deserializerFactory<RenameParams> readOptions

let parseExecuteCommandParams =
    deserializerFactory<ExecuteCommandParams> readOptions
