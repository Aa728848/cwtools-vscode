...
const BUILTIN_PROFILES: RuntimeAgentProfile[] = [
    ...
    },
    {
        ...
        tools: ['ask_user_question', 'select_tools', 'run_code', 'read_file', 'list_directory', 'glob_files', 'grep', 'document_symbols', 'workspace_symbols', 'go_to_definition', 'find_references', 'hover_symbol', 'query_*', 'search_*', 'get_*', 'web_*'],
    ...
    },
    {
        ...
        tools: ['ask_user_question', 'select_tools', 'run_code', 'read_file', 'list_directory', 'glob_files', 'grep', 'document_symbols', 'workspace_symbols', 'go_to_definition', 'find_references', 'hover_symbol', 'query_*', 'search_*', 'get_*', 'write_design_blueprint'],
        subagentCapabilities: { runCode: true },
        maxIterations: 30,
    ...
    },
    {
        ...
        authorizationCeiling: 'read_only',
        tools: ['ask_user_question', 'select_tools', 'run_code', 'read_file', 'glob_files', 'grep', 'document_symbols', 'workspace_symbols', 'go_to_definition', 'find_references', 'hover_symbol', 'query_*', 'get_*', 'validate_*', 'compare_*', 'git_ops'],
        subagentCapabilities: { runCode: true },
        maxIterations: 30,
